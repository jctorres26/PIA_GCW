  ...
  />
	...
	function setupScene() {		
		...
		wizardRunning.rotation.y = THREE.Math.degToRad(180);
			...
			loader.load('assets/escenario1.fbx',function(escenario){

				escenario.position.z = -10;
				escenario.position.x = 125;
				escenario.position.y = 5;

				escenario.scale.set(0.04,0.04,0.04);
...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="./escena2SP.php">
    <div class="container">
